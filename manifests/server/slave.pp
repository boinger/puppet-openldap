...
#
#  [ssl_cert]
#    Public certificate filename (should be located at ${file_prefix})
#    *Requires*: ssl => true
#    *Optional* (defaults to false)
#
#  [ssl_ca]
#    CA certificate filename (should be located at ${file_prefix})
#    *Requires*: ssl => true
#    *Optional* (defaults to false)
#
#  [ssl_key]
#    Private certificate filename (should be located at ${file_prefix})
#    *Requires*: ssl => true
#    *Optional* (defaults to false)
#
#  [sync_type]
...
class ldap::server::slave(
  ...
  $msg_suffix = "(filename). It should be located at ${file_prefix}"
